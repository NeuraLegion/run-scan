...
const retest = (uuid, scanName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield client.postJson(`${baseUrl}/api/v1/scans/${uuid}/retest`, { name: scanName || 'GitHub Actions' });
